...
import com.cherry.rabbitmq4spring.entity.Order;
import com.cherry.rabbitmq4spring.entity.Product;
...
//        String jsonStr = mapper.writeValueAsString(order);
        ...
        MessageProperties properties = new MessageProperties();
        properties.setContentType("application/json");
        properties.getHeaders().put("__TypeId__","com.cherry.rabbitmq4spring.entity.Order");
        Message message = new Message(jsonStr.getBytes(),properties);
        rabbitTemplate.convertAndSend("topic_exchange01","spring.abc",message);
    }
